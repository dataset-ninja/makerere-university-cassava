...
RELEASE_DATE: Optional[str] = "2022-08-18"  # e.g. "YYYY-MM-DD"
...
PREVIEW_IMAGE_ID: int = 12753476
# This should be filled AFTER uploading images to instance, just ID of any image.

GITHUB_URL: str = "https://github.com/dataset-ninja/makerere-university-cassava"
...
PAPER: Optional[Union[str, List[str], Dict[str, str]]] = {
    "Datasheet": "https://dataverse.harvard.edu/file.xhtml?fileId=6420464&version=1.1"
}
